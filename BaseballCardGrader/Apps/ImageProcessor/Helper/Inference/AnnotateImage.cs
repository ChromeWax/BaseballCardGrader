...
/// <summary>
/// Annotates an image using a segmentation mask generated by an ONNX model.
/// </summary>
public static class AnnotateImage
{
    /// <summary>
    /// Annotates the original image by applying a segmentation mask generated from the normal map using the provided ONNX model.
    /// </summary>
    /// <param name="modelMemoryStream">Onnx model in memory stream.</param>
    /// <param name="originalImage">Original image.</param>
    /// <param name="normalMap">Normal map.</param>
    /// <returns>Image in <see cref="SKBitmap"/> format.</returns>
